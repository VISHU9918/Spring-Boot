package com.example.jpacrud.ems.rest;
...
import com.example.jpacrud.ems.service.EmployeeService;
...
public class EmpRestController {
	...
	public Employee uodateEmp(@RequestBody Employee emp) {
		return employeeService.save(emp);
	}
	
	@DeleteMapping("/employees/{id}")
	public String deleteEmpById(@PathVariable("id") int eid) {
		employeeService.deletedbyId(eid);
