...
public class BookRestController {
	...
	static {
		bookList.add(new Book("C","Dennis R",300));
		bookList.add(new Book("Java","James G", 500));
		bookList.add(new Book("Python","Guido V R",400));
	...
	@PostMapping("/books")
	public Book saveBook(@RequestBody Book book) { //jackson
		bookList.add(book);
		return book;
	}
